const Nirva = () => {
  ...
  return <section className="py-20 px-6" id="nirva">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center cursor-pointer mb-16">
            ...
            <div className="relative">
              <div className="relative overflow-hidden rounded-lg">
                <img src="/lovable-uploads/d2995631-a794-4b9e-a0dd-212ecde82ae0.png" alt="Nirva - AI Wearable Companion for Mental Wellbeing" className="w-full h-auto object-cover rounded-md" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            {appFeatures.map((feature, index) => <div key={index} className="space-y-3">
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-lg">
              <img src="/lovable-uploads/3957ad14-82eb-45bd-b679-f2668b5a425e.png" alt="Nirva App Interface - Heart-to-heart conversations and Life Journals" className="w-full h-auto object-cover rounded-md" />
              <div className="absolute inset-0 bg-gradient-to-t from-background/10 to-transparent pointer-events-none"></div>
            </div>
          </div>
        </div>
