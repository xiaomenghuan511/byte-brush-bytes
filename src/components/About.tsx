              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-foreground/80">I became Head of Product at XREAL, leading the 0→1 development of full-stack AR glasses (hardware + software) now shipped globally—350K units sold, $10B valuation, and a passionate 30K-strong Reddit community.</p>
                  </div>
                </div>
