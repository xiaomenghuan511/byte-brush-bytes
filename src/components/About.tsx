              ...
              <div className="space-y-8">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-foreground/80">At 30, Meta recruited me from China to the U.S. to lead Spatial AI at Reality Labs, where I've supported a 50-engineer team to incubate and ship industry-first technologies used by millions.</p>
                  </div>
                </div>
