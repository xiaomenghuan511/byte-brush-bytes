              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-foreground/80">As Head of Product at XREAL, led the 0→1 development of full-stack AR glasses (hardware + software), shipped globally. Devices → 350K units sold, company → $1B valuation, community → 30K passionate followers on Reddit.</p>
                  </div>
                </div>
